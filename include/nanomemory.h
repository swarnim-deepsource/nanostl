...
struct _NANOSTL_TEMPLATE_VIS allocator_arg_t {
...
struct _NANOSTL_TEMPLATE_VIS default_delete {
  ...
  /*_LIBCPP_INLINE_VISIBILITY*/ constexpr default_delete()
      __NANOSTL_NOEXCEPT = default;
  template <class _Up>
...
struct _NANOSTL_TEMPLATE_VIS default_delete<_Tp[]> {
 ...
 public:
  ...
  /*_LIBCPP_INLINE_VISIBILITY*/
  default_delete(const default_delete<_Up[]>&,
                 typename _EnableIfConvertible<_Up>::type* = 0)
      __NANOSTL_NOEXCEPT {}

  template <class _Up>
  /*_LIBCPP_INLINE_VISIBILITY*/
  typename _EnableIfConvertible<_Up>::type operator()(_Up* __ptr) const
      __NANOSTL_NOEXCEPT {
    static_assert(sizeof(_Tp) > 0,
                  "default_delete can not delete incomplete type");
    static_assert(!is_void<_Tp>::value,
...
struct __compressed_pair_elem {
  ...
  /*_LIBCPP_INLINE_VISIBILITY*/ constexpr __compressed_pair_elem(
      __default_init_tag) {}
  /*_LIBCPP_INLINE_VISIBILITY*/ constexpr __compressed_pair_elem(
      __value_init_tag)
      : __value_() {}
  ...
  _LIBCPP_INLINE_VISIBILITY reference __get() __NANOSTL_NOEXCEPT {
    return __value_;
  }
  _LIBCPP_INLINE_VISIBILITY
...
struct __compressed_pair_elem<_Tp, _Idx, true> : private _Tp {
  ...
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR
  __compressed_pair_elem(__value_init_tag)
      : __value_type() {}

  template <class _Up, class = typename enable_if<
                           !is_same<__compressed_pair_elem,
                                    typename decay<_Up>::type>::value>::type>
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR explicit __compressed_pair_elem(
      _Up&& __u)
...
class __compressed_pair : private __compressed_pair_elem<_T1, 0>,
 ...
 public:
  ...
  static_assert(
      ...
      "__compressed_pair cannot be instantiated when T1 and T2 are the same "
      "type; "
  ...
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR __compressed_pair(_U1&& __t1,
                                                                _U2&& __t2)
      : _Base1(_VNANOSTL::forward<_U1>(__t1)),
        _Base2(_VNANOSTL::forward<_U2>(__t2)) {}
  ...
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR static _Base1* __get_first_base(
      __compressed_pair* __pair) __NANOSTL_NOEXCEPT {
    return static_cast<_Base1*>(__pair);
  }
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR static _Base2* __get_second_base(
      __compressed_pair* __pair) __NANOSTL_NOEXCEPT {
    return static_cast<_Base2*>(__pair);
  }

  _LIBCPP_INLINE_VISIBILITY
  void swap(__compressed_pair& __x) __NANOSTL_NOEXCEPT_(
...
template <class _T1, class _T2>
inline _LIBCPP_INLINE_VISIBILITY void swap(__compressed_pair<_T1, _T2>& __x,
...
class _LIBCPP_UNIQUE_PTR_TRIVIAL_ABI _NANOSTL_TEMPLATE_VIS unique_ptr {
 public:
  ...
  typedef /*_LIBCPP_NODEBUG*/ typename __pointer<_Tp, deleter_type>::type
      pointer;
 ...
 public:
  ...
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR unique_ptr() __NANOSTL_NOEXCEPT
      : __ptr_(pointer(), __default_init_tag()) {}

  template <bool _Dummy = true,
            class = _EnableIfDeleterDefaultConstructible<_Dummy> >
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR unique_ptr(nullptr_t)
      __NANOSTL_NOEXCEPT : __ptr_(pointer(), __default_init_tag()) {}

  // FIXME:
  // template <bool _Dummy = true,
  //          class = _EnableIfDeleterDefaultConstructible<_Dummy> >
  //_LIBCPP_INLINE_VISIBILITY
  // explicit unique_ptr(pointer __p) __NANOSTL_NOEXCEPT : __ptr_(__p,
  // __default_init_tag()) {}

  _LIBCPP_INLINE_VISIBILITY
  explicit unique_ptr(pointer __p) __NANOSTL_NOEXCEPT
      : __ptr_(__p, __default_init_tag()) {}

  template <bool _Dummy = true,
            class = _EnableIfDeleterConstructible<_LValRefType<_Dummy> > >
  _LIBCPP_INLINE_VISIBILITY unique_ptr(pointer __p, _LValRefType<_Dummy> __d)
      __NANOSTL_NOEXCEPT : __ptr_(__p, __d) {}

  template <bool _Dummy = true,
            class = _EnableIfDeleterConstructible<_GoodRValRefType<_Dummy> > >
  _LIBCPP_INLINE_VISIBILITY unique_ptr(pointer __p,
                                       _GoodRValRefType<_Dummy> __d)
      __NANOSTL_NOEXCEPT : __ptr_(__p, _VNANOSTL::move(__d)) {
  ...
  unique_ptr(unique_ptr&& __u) __NANOSTL_NOEXCEPT
      : __ptr_(__u.release(),
               _VNANOSTL::forward<deleter_type>(__u.get_deleter())) {}

  template <class _Up, class _Ep,
            class = _EnableIfMoveConvertible<unique_ptr<_Up, _Ep>, _Up>,
            class = _EnableIfDeleterConvertible<_Ep> >
  _LIBCPP_INLINE_VISIBILITY unique_ptr(unique_ptr<_Up, _Ep>&& __u)
      __NANOSTL_NOEXCEPT
  ...
  _LIBCPP_INLINE_VISIBILITY
  pointer operator->() const __NANOSTL_NOEXCEPT { return __ptr_.first(); }
  _LIBCPP_INLINE_VISIBILITY
  pointer get() const __NANOSTL_NOEXCEPT { return __ptr_.first(); }
  _LIBCPP_INLINE_VISIBILITY
  deleter_type& get_deleter() __NANOSTL_NOEXCEPT { return __ptr_.second(); }
  _LIBCPP_INLINE_VISIBILITY
  ...
  void reset(pointer __p = pointer()) __NANOSTL_NOEXCEPT {
    ...
    __ptr_.first() = __p;
    if (__tmp) __ptr_.second()(__tmp);
  }

  _LIBCPP_INLINE_VISIBILITY
  void swap(unique_ptr& __u) __NANOSTL_NOEXCEPT { __ptr_.swap(__u.__ptr_); }
};

template <class _Tp, class _Dp>
class _LIBCPP_UNIQUE_PTR_TRIVIAL_ABI _NANOSTL_TEMPLATE_VIS
    unique_ptr<_Tp[], _Dp> {
 public:
  typedef _Tp element_type;
  typedef _Dp deleter_type;
 ...
 private:
  ...
  template <class _UDel>
  using _EnableIfDeleterAssignable /*_LIBCPP_NODEBUG*/ =
      typename enable_if<is_assignable<_Dp&, _UDel&&>::value>::type;
 ...
 public:
  ...
  _LIBCPP_INLINE_VISIBILITY explicit unique_ptr(_Pp __p) __NANOSTL_NOEXCEPT
      : __ptr_(__p, __default_init_tag()) {}

  template <class _Pp, bool _Dummy = true,
            class = _EnableIfDeleterConstructible<_LValRefType<_Dummy> >,
            class = _EnableIfPointerConvertible<_Pp> >
  _LIBCPP_INLINE_VISIBILITY unique_ptr(_Pp __p, _LValRefType<_Dummy> __d)
      __NANOSTL_NOEXCEPT : __ptr_(__p, __d) {}

  template <bool _Dummy = true,
            class = _EnableIfDeleterConstructible<_LValRefType<_Dummy> > >
  _LIBCPP_INLINE_VISIBILITY unique_ptr(nullptr_t, _LValRefType<_Dummy> __d)
      __NANOSTL_NOEXCEPT : __ptr_(nullptr, __d) {}

  template <class _Pp, bool _Dummy = true,
            class = _EnableIfDeleterConstructible<_GoodRValRefType<_Dummy> >,
            class = _EnableIfPointerConvertible<_Pp> >
  _LIBCPP_INLINE_VISIBILITY unique_ptr(_Pp __p, _GoodRValRefType<_Dummy> __d)
      __NANOSTL_NOEXCEPT : __ptr_(__p, _VNANOSTL::move(__d)) {
    static_assert(!is_reference<deleter_type>::value,
                  "rvalue deleter bound to reference");
  }
  ...
  template <bool _Dummy = true,
            class = _EnableIfDeleterConstructible<_GoodRValRefType<_Dummy> > >
  _LIBCPP_INLINE_VISIBILITY unique_ptr(nullptr_t, _GoodRValRefType<_Dummy> __d)
      __NANOSTL_NOEXCEPT : __ptr_(nullptr, _VNANOSTL::move(__d)) {
    static_assert(!is_reference<deleter_type>::value,
                  "rvalue deleter bound to reference");
  }
...
inline _LIBCPP_INLINE_VISIBILITY
    ...
    swap(unique_ptr<_Tp, _Dp>& __x,
         unique_ptr<_Tp, _Dp>& __y) __NANOSTL_NOEXCEPT {
  __x.swap(__y);
}

template <class _T1, class _D1, class _T2, class _D2>
inline _LIBCPP_INLINE_VISIBILITY bool operator==(
...
inline _LIBCPP_INLINE_VISIBILITY bool operator==(
    const unique_ptr<_T1, _D1>& __x, nullptr_t) __NANOSTL_NOEXCEPT {
  return !__x;
}

template <class _T1, class _D1>
inline _LIBCPP_INLINE_VISIBILITY bool operator==(
    nullptr_t, const unique_ptr<_T1, _D1>& __x) __NANOSTL_NOEXCEPT {
  return !__x;
}
...
template <class _T1, class _D1>
inline _LIBCPP_INLINE_VISIBILITY bool operator<(const unique_ptr<_T1, _D1>& __x,
                                                nullptr_t) {
  typedef typename unique_ptr<_T1, _D1>::pointer _P1;
...
template <class _T1, class _D1>
inline _LIBCPP_INLINE_VISIBILITY bool operator<(
    nullptr_t, const unique_ptr<_T1, _D1>& __x) {
  typedef typename unique_ptr<_T1, _D1>::pointer _P1;
...
template <class _Tp>
struct _NANOSTL_TEMPLATE_VIS hash;
