...
#define optional_CPP11_140_C290_G490                                          \
  ((optional_CPP11_OR_GREATER_ && (optional_COMPILER_CLANG_VERSION >= 290 ||  \
                                   optional_COMPILER_GNUC_VERSION >= 490)) || \
   (optional_COMPILER_MSVC_VER >= 1900))
...
struct is_assignable : std11::true_type {};
#endif
...
#else
template <class T>
struct is_move_constructible : std11::true_type {};
#endif
...
#else
template <class T>
struct is_nothrow_move_assignable : std11::true_type {};
#endif
...
#else
template <class T>
struct is_nothrow_move_constructible : std11::true_type {};
#endif
...
#else
template <class T>
struct is_trivially_copy_constructible : std11::true_type {};
#endif
...
#else
template <class T>
struct is_trivially_move_constructible : std11::true_type {};
#endif
...
struct is_nothrow_swappable {
  ...
  static auto test(int /*unused*/)
      -> std11::integral_constant<bool, satisfies<T>()> {}
...
union storage_t {
  ...
  explicit storage_t(value_type &&v) { construct_value(nanostl::move(v)); }
  ...
  value_type &&value() optional_refref_qual { return nanostl::move(value()); }
  ...
  using aligned_storage_t =
      typename nanostl::aligned_storage<sizeof(value_type),
...
class optional {
  optional_static_assert(
      (!nanostl::is_same<typename nanostl::remove_cv<T>::type,
                         nullopt_t>::value),
      ...
      optional_static_assert(
          ...
          optional_static_assert(
              (nanostl::is_object<T>::value &&
               nanostl::is_destructible<T>::value &&
               !nanostl::is_array<T>::value),
 ...
 public:
  ...
  optional_constexpr explicit optional(nonstd_lite_in_place_t(T),
                                       ...
                                       Args &&...args)
      : has_value_(true), contained(T(il, nanostl::forward<Args>(args)...)) {}
  ...
  operator=(optional const &other)
      noexcept(std11::is_nothrow_move_assignable<T>::value
  ...
  operator=(optional &&other) noexcept {
    if ((has_value() == true) && (other.has_value() == false)) {
      ...
      initialize(nanostl::move(*other));
    } else if ((has_value() == true) && (other.has_value() == true)) {
      contained.value() = nanostl::move(*other);
    }
    return *this;
  }
  ...
  optional_REQUIRES_R(
      ...
      nanostl::is_constructible<T, U>::value
          ...
          !nanostl::is_same<typename std20::remove_cvref<U>::type,
                            optional<T> >::value &&
          !(nanostl::is_scalar<T>::value &&
            nanostl::is_same<T, typename nanostl::decay<U>::type>::value))
  operator=(U &&value) {
    if (has_value()) {
...
template <typename T
#if optional_CPP11_OR_GREATER
              optional_REQUIRES_T(std11::is_move_constructible<T>::value
...
template <typename T>
optional_constexpr optional<typename nanostl::decay<T>::type> make_optional(
    T &&value) {
...
optional_constexpr optional<T> make_optional(nanostl::initializer_list<U> il,
                                             Args &&...args) {
  return optional<T>(nonstd_lite_in_place(T), il,
...
struct nanostl::hash<nonstd::optional<T> > {
 public:
  nanostl::size_t operator()(nonstd::optional<T> const &v) const
      optional_noexcept {
