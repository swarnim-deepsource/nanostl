...
struct sum : nanostl::integral_constant<T, (Ns + ... + T(0))> {};
...
struct collector<index_sequence<Is...>, Ns...> : chars<Is, Ns>... {};
...
struct sum<true, N, T, Ns...> {
  using type = nanostl::integral_constant<
      T, T(sizeof(collector<make_index_sequence<N>, Ns...>) - N)>;
};
...
template <typename T, T... Ns>
struct sum : impl::sum<nanostl::is_unsigned<T>::value, sizeof...(Ns) + 1, T,
                       Ns..., 0>::type {};

#endif

template <typename T, T... Ns>
struct sum<integer_sequence<T, Ns...> > : sum<T, Ns...> {};
