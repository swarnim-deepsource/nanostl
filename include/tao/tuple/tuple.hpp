...
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON seq::at_index_t<I, Ts...>&
...
using is_nothrow_swappable =
    nanostl::integral_constant<bool, noexcept(swap(nanostl::declval<T&>(),
                                                   nanostl::declval<T&>()))>;
...
using uses_alloc_ctor_t = uses_alloc_ctor<
    nanostl::uses_allocator<T, A>::value,
    nanostl::is_constructible<T, nanostl::allocator_arg_t, A, As...>::value>*;

template <nanostl::size_t I, typename T,
          bool = nanostl::is_empty<T>::value && !is_final<T>::value>
struct tuple_value {
  T value;
  ...
  constexpr tuple_value()
      noexcept(nanostl::is_nothrow_default_constructible<T>::value)
      : value() {
    static_assert(
        !nanostl::is_reference<T>::value,
        "attempted to default construct a reference element in a tuple");
  }

  TAO_TUPLE_SUPPRESS_NVCC_HD_WARN
  template <bool B, typename A>
  TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple_value(uses_alloc_ctor<false, B>*,
                                             const A&)
      : value() {
    static_assert(
        !nanostl::is_reference<T>::value,
  ...
  TAO_TUPLE_SUPPRESS_NVCC_HD_WARN
  template <typename A>
  TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple_value(uses_alloc_ctor<true, true>*,
                                             const A& a)
  ...
  TAO_TUPLE_SUPPRESS_NVCC_HD_WARN
  template <typename A>
  TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple_value(uses_alloc_ctor<true, false>*,
                                             const A& a)
      : value(a) {
    static_assert(
        !nanostl::is_reference<T>::value,
  ...
  template <
      typename U,
      typename = impl::enable_if_t<!nanostl::is_same<
          typename nanostl::decay<U>::type, tuple_value>::value>,
      typename = impl::enable_if_t<nanostl::is_constructible<T, U>::value> >
  TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON explicit tuple_value(U&& v)
      noexcept(nanostl::is_nothrow_constructible<T, U>::value)
  ...
  template <typename U>
  TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple_value& operator=(U&& v)
      noexcept(nanostl::is_nothrow_assignable<T&, U>::value) {
    value = nanostl::forward<U>(v);
    return *this;
  }
...
struct tuple_value<I, T, true> : private T {
  TAO_TUPLE_SUPPRESS_NVCC_HD_WARN
  constexpr TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple_value()
      noexcept(nanostl::is_nothrow_default_constructible<T>::value)
      : T() {}
...
struct tuple_base<seq::index_sequence<Is...>, Ts...> : tuple_value<Is, Ts>... {
  constexpr tuple_base() = default;

  template <typename... Us>
  TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON explicit tuple_base(
      Us&&... us)
      : tuple_value<Is, Ts>(nanostl::forward<Us>(us))... {}

  template <typename A, typename... Us>
  TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON
  tuple_base(nanostl::allocator_arg_t, const A& a, Us&&... us)
      : tuple_value<Is, Ts>(uses_alloc_ctor_t<Ts, A, Us>(), a,
                            nanostl::forward<Us>(us))... {}
  ...
  template <typename... Us>
  TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple_base& operator=(const tuple<Us...>& v)
      noexcept(seq::is_all<nanostl::is_nothrow_assignable<
  ...
  template <typename... Us>
  TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple_base&
  operator=(tuple<Us...>&& v) noexcept(
      seq::is_all<nanostl::is_nothrow_assignable<Ts&, Us&&>::value...>::value) {
#ifdef TAO_SEQ_FOLD_EXPRESSIONS
    (tuple_value<Is, Ts>::operator=(get<Is>(nanostl::move(v))), ...);
#else
    (void)swallow{
        (tuple_value<Is, Ts>::operator=(get<Is>(nanostl::move(v))), true)...,
        true};
#endif
    return *this;
  }
...
#ifdef TAO_SEQ_FOLD_EXPRESSIONS
    (static_cast<tuple_value<Is, Ts>&>(*this).swap(
         static_cast<tuple_value<Is, Ts>&>(v)),
     ...);
#else
    (void)swallow{(static_cast<tuple_value<Is, Ts>&>(*this).swap(
                       static_cast<tuple_value<Is, Ts>&>(v)),
                   true)...,
                  true};
#endif
...
struct tuple {
 private:
  ...
  friend TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON
      seq::at_index_t<I, Us...>&
 ...
 public:
  ...
  template <
      typename dummy = void,
      typename = impl::enable_if_t<seq::is_all<impl::dependent_type<
          nanostl::is_default_constructible<Ts>, dummy>::value...>::value> >
  TAO_TUPLE_CUDA_ANNOTATE_COMMON constexpr tuple()
      noexcept(seq::is_all<
               nanostl::is_nothrow_default_constructible<Ts>::value...>::value)
      : base() {}

  TAO_TUPLE_SUPPRESS_NVCC_HD_WARN
  template <typename dummy = void,
            typename = impl::enable_if_t<seq::is_all<impl::dependent_type<
                nanostl::is_copy_constructible<Ts>, dummy>::value...>::value> >
  TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON explicit tuple(
      const Ts&... ts)
      noexcept(seq::is_all<
               nanostl::is_nothrow_copy_constructible<Ts>::value...>::value)
      : base(ts...) {}

  TAO_TUPLE_SUPPRESS_NVCC_HD_WARN
  template <typename... Us,
            typename = impl::enable_if_t<sizeof...(Us) == sizeof...(Ts)>,
            typename = impl::enable_if_t<seq::is_all<
                nanostl::is_constructible<Ts, Us&&>::value...>::value> >
  TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON explicit tuple(Us&&... us)
      noexcept(seq::is_all<
               nanostl::is_nothrow_constructible<Ts, Us&&>::value...>::value)
  ...
  template <typename... Us,
            typename = impl::enable_if_t<sizeof...(Us) == sizeof...(Ts)>,
            typename = impl::enable_if_t<seq::is_all<
                nanostl::is_constructible<Ts, const Us&>::value...>::value> >
  TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON explicit tuple(
      const tuple<Us...>& v)
      noexcept(seq::is_all<nanostl::is_nothrow_constructible<
                   Ts, const Us&>::value...>::value)
      : base(v) {}
  ...
  TAO_TUPLE_SUPPRESS_NVCC_HD_WARN
  template <
      typename A, typename dummy = void,
      typename = impl::enable_if_t<seq::is_all<impl::dependent_type<
          nanostl::is_default_constructible<Ts>, dummy>::value...>::value> >
  TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple(nanostl::allocator_arg_t, const A& a)
  ...
  template <typename T, typename = impl::enable_if_t<
                            nanostl::is_assignable<base_t&, T>::value> >
  TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple& operator=(T&& v)
      noexcept(nanostl::is_nothrow_assignable<base_t&, T>::value) {
...
struct tuple<> {
  ...
  TAO_TUPLE_SUPPRESS_NVCC_HD_WARN
  template <typename A>
  TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple(nanostl::allocator_arg_t,
                                       const A&) noexcept {}

  TAO_TUPLE_SUPPRESS_NVCC_HD_WARN
  template <typename A>
  TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple(nanostl::allocator_arg_t, const A&,
...
// make_tuple
template <typename... Ts, typename R = tuple<impl::make_tuple_return_t<
                              typename nanostl::decay<Ts>::type>...> >
...
// forward_as_tuple
template <typename... Ts>
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple<Ts&&...>
...
// tie
template <typename... Ts>
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON tuple<Ts&...> tie(
    Ts&... ts) noexcept {
  return tuple<Ts&...>(ts...);
}

// tuple_cat is found at the end, as it requires access to tuple_element_t and
// get<I>
...
template <nanostl::size_t I, typename... Ts>
struct tuple_element<I, tuple<Ts...> > : seq::at_index<I, Ts...> {};
...
get(tuple<Ts...>& v) noexcept {
  return static_cast<impl::tuple_value<I, seq::at_index_t<I, Ts...> >&>(v.base)
      .get();
}
...
get(tuple<Ts...>&& v) noexcept {
  ...
  return static_cast<type&&>(
      static_cast<impl::tuple_value<I, type>&>(v.base).get());
}
...
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON const
  ...
  return static_cast<const impl::tuple_value<I, seq::at_index_t<I, Ts...> >&>(
             v.base)
      .get();
}
...
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON const
  ...
  return static_cast<const type&&>(
      static_cast<const impl::tuple_value<I, type>&>(v.base).get());
}
...
using count_of =
    seq::sum<nanostl::size_t, (nanostl::is_same<T, Ts>::value ? 1 : 0)...>;
...
// get<T>
template <typename T, typename... Ts>
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON T& get(
    tuple<Ts...>& v) noexcept {
...
template <typename T, typename... Ts>
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON const T& get(
    const tuple<Ts...>& v) noexcept {
  return get<impl::index_of<T, Ts...>::value>(v);
}
...
struct tuple_equal<seq::index_sequence<Is...> > {
  ...
  static TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON bool apply(
      const T& lhs, const U& rhs)
      noexcept(noexcept((static_cast<bool>(get<Is>(lhs) == get<Is>(rhs)) &&
                         ...))) {
...
struct tuple_equal {
  ...
  static TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON bool apply(
      const T& lhs, const U& rhs)
      noexcept(noexcept(static_cast<bool>(get<I>(lhs) == get<I>(rhs)) &&
                        tuple_equal<I + 1, S>::apply(lhs, rhs))) {
    return static_cast<bool>(get<I>(lhs) == get<I>(rhs)) &&
           tuple_equal<I + 1, S>::apply(lhs, rhs);
  }
};
...
struct tuple_less {
  ...
  static TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON bool apply(
      const T& lhs, const U& rhs)
      noexcept(noexcept(static_cast<bool>(get<I>(lhs) < get<I>(rhs)) ||
                        (!static_cast<bool>(get<I>(rhs) < get<I>(lhs)) &&
                         tuple_less<I + 1, S>::apply(lhs, rhs)))) {
    return static_cast<bool>(get<I>(lhs) < get<I>(rhs)) ||
           (!static_cast<bool>(get<I>(rhs) < get<I>(lhs)) &&
            tuple_less<I + 1, S>::apply(lhs, rhs));
  }
...
template <typename... Ts, typename... Us,
          typename = impl::enable_if_t<sizeof...(Ts) == sizeof...(Us)> >
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON bool
operator==(const tuple<Ts...>& lhs, const tuple<Us...>& rhs) noexcept(noexcept(
    impl::tuple_equal<seq::make_index_sequence<sizeof...(Ts)> >::apply(lhs,
                                                                       rhs))) {
  return impl::tuple_equal<seq::make_index_sequence<sizeof...(Ts)> >::apply(
      lhs, rhs);
}
...
template <typename... Ts, typename... Us,
          typename = impl::enable_if_t<sizeof...(Ts) == sizeof...(Us)> >
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON bool operator==(
    const tuple<Ts...>& lhs, const tuple<Us...>& rhs)
    noexcept(noexcept(impl::tuple_equal<0, sizeof...(Ts)>::apply(lhs, rhs))) {
...
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON bool operator<(
    const tuple<Ts...>& lhs, const tuple<Us...>& rhs)
    noexcept(noexcept(impl::tuple_less<0, sizeof...(Ts)>::apply(lhs, rhs))) {
...
// swap
template <typename... Ts>
TAO_TUPLE_CUDA_ANNOTATE_COMMON void swap(tuple<Ts...>& lhs, tuple<Ts...>& rhs)
...
struct count_less_or_equal : seq::sum<nanostl::size_t, ((Ns <= M) ? 1 : 0)...> {
};
...
struct tuple_cat_result<seq::index_sequence<Os...>, seq::index_sequence<Is...>,
                        Ts...> {
  using type =
      tuple<typename tuple_element<Is, seq::at_index_t<Os, Ts...> >::type...>;
};
...
struct tuple_cat_helper {
  ...
  using result_index_sequence =
      seq::make_index_sequence<seq::sum<tuple_size_sequence>::value>;

  using outer_index_sequence =
      expand_t<result_index_sequence,
               seq::inclusive_scan_t<tuple_size_sequence> >;
  using inner_index_sequence =
      seq::minus_t<result_index_sequence,
                   seq::map_t<outer_index_sequence,
                              seq::exclusive_scan_t<tuple_size_sequence> > >;

  using result_type =
      tuple_cat_result_t<outer_index_sequence, inner_index_sequence, Ts...>;
};

template <typename R, nanostl::size_t... Os, nanostl::size_t... Is, typename T>
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON R
...
// tuple_cat
template <typename... Ts,
          typename H = impl::tuple_cat_helper<
              typename nanostl::remove_reference<Ts>::type...>,
          typename R = typename H::result_type>
TAO_TUPLE_CONSTEXPR TAO_TUPLE_CUDA_ANNOTATE_COMMON R tuple_cat(Ts&&... ts) {
  return impl::tuple_cat<R>(typename H::outer_index_sequence(),
                            typename H::inner_index_sequence(),
                            tao::forward_as_tuple(nanostl::forward<Ts>(ts)...));
}
